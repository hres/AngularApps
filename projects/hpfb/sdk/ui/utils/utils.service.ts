...
import { CANADA, USA, FRENCH, CANADAOLD, USAOLD } from '../common.constants';
...
export class UtilsService {
  ...
  isCanada(countryValue): boolean {
    return countryValue === CANADA || countryValue === CANADAOLD;
  }
  ...
  isUsa(countryValue): boolean {
    return countryValue === USA || countryValue === USAOLD;;
  }
