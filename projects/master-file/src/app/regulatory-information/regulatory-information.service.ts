...
export class RegulatoryInformationService {
  ...
  public mapFormModelToDataModel(
    ...
    // masterFileModel.master_file_name =
    //   formRecord.controls['masterFileName'].value;
    // masterFileModel.master_file_number =
    //   formRecord.controls['masterFileNumber'].value;
    // masterFileModel.master_file_type =
    //   formRecord.controls['masterFileType'].value;
  ...
  public mapDataModelToFormModel(
    ...
    // formRecord.controls['masterFileName'].setValue(
    //   masterFileModel.master_file_name
    // );
    // formRecord.controls['masterFileNumber'].setValue(
    //   masterFileModel.master_file_number
    // );
    // formRecord.controls['masterFileType'].setValue(
    //   masterFileModel.master_file_type
    // );
