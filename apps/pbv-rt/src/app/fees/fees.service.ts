...
export class FeesService {
  ...
  public mapDataModelToFormModel(dataModel: FeeDetails, formRecord: FormGroup): void {
    ...
    if (dataModel.mitigation?.mitigation_type?._id) {
      ...
      formRecord.controls['certifyGovOrg'].setValue(dataModel.mitigation.certify_government_organization=='Y' || dataModel.mitigation.certify_government_organization=='true'? true:null);
      formRecord.controls['certifyISAD'].setValue(dataModel.mitigation.certify_isad=='Y' || dataModel.mitigation.certify_isad=='true' ? true:null);
      formRecord.controls['certifyFundedInstitution'].setValue(dataModel.mitigation.certify_funded_health_institution=='Y' || dataModel.mitigation.certify_funded_health_institution=='true' ? true:null);
      formRecord.controls['certifySmallBusiness'].setValue(dataModel.mitigation.certify_small_business=='Y' || dataModel.mitigation.certify_small_business=='true' ? true:null);
      formRecord.controls['certifyUrgentHealthNeed'].setValue(dataModel.mitigation.certify_urgent_health_need=='Y' || dataModel.mitigation.certify_urgent_health_need=='true'? true:null);
