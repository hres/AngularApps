...
import { ICode, IIdTextLabel } from '@hpfb/sdk/ui';
...
export class ApplicantService {
  ...
  public mapFormModelToDataModel(
    ...
    this._addressDetailsService.mapFormModelToDataModelCanadianAddress(
      applicantAddressFormGroupValue,
      applicant.address,
      lang,
      countryList,
      combinedProvStatList
    );
    this._contactDetailsService.mapFormModelToDataModel(
      applicantContactFormGroupValue,
      applicant.contact,
      lang,
      languageList
    ...
    if (formValue['isBillingDifferent']) {
      ...
      this._addressDetailsService.mapFormModelToDataModel(
        billingAddressFormGroupValue,
        billing.address,
        lang,
        countryList,
  ...
  public mapDataModelToFormModel(
    ...
    billingModel: IApplicant,
    formRecord: FormGroup
  ) {
    formRecord.controls['applicantName'].setValue(
      applicantModel.applicant_name
    );
    formRecord.controls['craBusinessNumber'].setValue(
      applicantModel.cra_business_number
    );
    formRecord.controls['cspNumber'].setValue(
      applicantModel.csp_customer_number
    );
