export const ROOT_TAG: string = 'CERTIFICATE_SUPPLEMENTARY_PROTECTION';
export const VERSION_TAG_PATH: string = 'CERTIFICATE_SUPPLEMENTARY_PROTECTION.software_version';
