		...
		<section>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h2 class="panel-title">Inscription d'une transaction réglementaire</h2>
				</div>
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<span class="mouseHover"><xsl:value-of select="/descendant-or-self::application_info/description_type/@label_fr"/></span>
									</div>
								</div>
								<xsl:if test="/descendant-or-self::application_info/device_class != ''">
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<strong>Classe de l'instrument :&#160;</strong>
								...
								<xsl:if test="/descendant-or-self::application_info/amend_reasons/amend_reason">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><strong>Raison de la modification</strong></div>
									</div>
								...
								<xsl:if test="/descendant-or-self::application_info/proposed_licence_name != ''">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<strong>Nom d'homologation proposé :&#160;</strong>
								...
								<xsl:if test="/descendant-or-self::application_info/device_name != ''">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<strong>Nom de l'instrument, tel qu'il apparaît sur l'étiquette :&#160;</strong>
								...
								<xsl:if test="/descendant-or-self::application_info/org_manufacture_id != ''">
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<strong>Numéro d'homologation du fabricant d'origine :&#160;</strong>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<strong>Est-ce qu'un fichier excel des détails de l'instrument est inclus ?&#160;</strong>
