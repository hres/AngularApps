...
.minWidth300 {
        ...
        <div class="panel-body">
          ...
          <div class="row">
            <xsl:if test="fee_details/account_number != ''">
              <div class="col-xs-6">
                <strong>Customer/Client account number:&#160;</strong>
                <span class="mouseHover normalWeight">
  ...
  <xsl:template name="contact">
    ...
    <div class="row">
      <div class="col-xs-6">
        <strong>Phone nnumber (including area code):&#160;</strong>
        <span class="mouseHover normalWeight">
    ...
    <div class="row">
      <div class="col-xs-6">
        <strong>Fax number (including area code).

By not entering a fax number, you authorise receipt of billing communication by email. :&#160;</strong>
        <span class="mouseHover normalWeight">
